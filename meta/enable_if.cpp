 ...
 * to the number of elements along the N-th dimension of the array,
 * if N is in [0, std::rank<T>::value). For any other type, or if
 * T is an array of unknown bound along its first dimension and N
 * is 0, value is 0.
...
int main() {
    ...
    std::cout << *reinterpret_cast<std::string *>(&u) << std::endl;
